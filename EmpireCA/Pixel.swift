...
public struct Pixel {
     ...
     */
    public init(red: CGFloat, green: CGFloat, blue: CGFloat, premultiplyingWithAlpha alpha: CGFloat) {
    ...
    private init(cRed red: CGFloat, green: CGFloat, blue: CGFloat, alpha: CGFloat) {
